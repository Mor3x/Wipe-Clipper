...
namespace WipeClipperPlugin {
    class Regex {
        private static readonly System.Text.RegularExpressions.Regex _wipe = new System.Text.RegularExpressions.Regex(@"(([0-9,a-f,A-F]{8}):4000000F)", RegexOptions.Compiled);
